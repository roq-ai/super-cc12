...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'inventory.update': {
    ...
    tenantPath: ['merchant', 'inventory'],
    userPath: [],
  },
  'payment.create': {
    roles: ['owner', 'cashier'],
    key: 'new-payment-received',
    tenantPath: ['merchant', 'order', 'payment'],
    userPath: [],
  },
  'loyalty_program.create': {
    roles: ['owner', 'manager'],
    key: 'loyalty-program-start',
    tenantPath: ['merchant', 'loyalty_program'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'manager', 'cashier', 'inventory-manager'];
