...
export function OrderListPage(props: OrderListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrders({
        relations: ['user', 'merchant', 'payment.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['order_number.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'order_number', header: 'Order Number', accessorKey: 'order_number' },
    {
      id: 'order_date',
      header: 'Order Date',
    ...
    { id: 'total_amount', header: 'total_amount', accessorKey: 'total_amount' },
