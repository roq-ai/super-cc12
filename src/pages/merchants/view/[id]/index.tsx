...
import { getMerchantById } from 'apiSdk/merchants';
import { MerchantInterface } from 'interfaces/merchant';
import { InventoryListPage } from 'pages/inventories';
import { LoyaltyProgramListPage } from 'pages/loyalty-programs';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('merchant', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/merchants/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="merchant" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
